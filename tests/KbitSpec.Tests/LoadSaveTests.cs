...
public class LoadSaveTests
{
    ...
    public void TestDemoKbits()
    {
        ...
        var savePath = Path.Combine(PathUtil.CreateTempDir(), "demo.kbits");
    ...
    public void TestDemoKbitx()
    {
        ...
        var savePath = Path.Combine(PathUtil.CreateTempDir(), "demo.kbitx");
    ...
    public void TestAthensKbits()
    {
        ...
        var savePath = Path.Combine(PathUtil.CreateTempDir(), "Athens.kbits");
        var font = KbitFont.LoadKbits(loadPath);
        font.SaveKbits(savePath);
        Assert.Equal(File.ReadAllBytes(loadPath), File.ReadAllBytes(savePath));
    }
    ...
    public void TestAthensKbitx()
    {
        ...
        var savePath = Path.Combine(PathUtil.CreateTempDir(), "Athens.kbitx");
        var font = KbitFont.LoadKbitx(loadPath);
        font.SaveKbitx(savePath);
        Assert.Equal(File.ReadAllText(loadPath).Replace("\r\n", "\n"), File.ReadAllText(savePath));
    }
    ...
    public void TestGeneva12Kbits()
    {
        ...
        var savePath = Path.Combine(PathUtil.CreateTempDir(), "Geneva-12.kbits");
        var font = KbitFont.LoadKbits(loadPath);
        font.SaveKbits(savePath);
        Assert.Equal(File.ReadAllBytes(loadPath), File.ReadAllBytes(savePath));
    }
    ...
    public void TestGeneva12Kbitx()
    {
        ...
        var savePath = Path.Combine(PathUtil.CreateTempDir(), "Geneva-12.kbitx");
        var font = KbitFont.LoadKbitx(loadPath);
        font.SaveKbitx(savePath);
        Assert.Equal(File.ReadAllText(loadPath).Replace("\r\n", "\n"), File.ReadAllText(savePath));
    }
    ...
    public void TestNewYork14Kbits()
    {
        ...
        var savePath = Path.Combine(PathUtil.CreateTempDir(), "New-York-14.kbits");
        var font = KbitFont.LoadKbits(loadPath);
        font.SaveKbits(savePath);
        Assert.Equal(File.ReadAllBytes(loadPath), File.ReadAllBytes(savePath));
    }
    ...
    public void TestNewYork14Kbitx()
    {
        ...
        var savePath = Path.Combine(PathUtil.CreateTempDir(), "New-York-14.kbitx");
        var font = KbitFont.LoadKbitx(loadPath);
        font.SaveKbitx(savePath);
        Assert.Equal(File.ReadAllText(loadPath).Replace("\r\n", "\n"), File.ReadAllText(savePath));
    }
